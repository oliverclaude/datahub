...
import com.linkedin.datahub.graphql.types.ssis.mappers.SsisControlFlowMapper;
import com.linkedin.datahub.graphql.types.ssis.mappers.SsisControlFlowUpdateInputMapper;
...
public class SsisControlFlowType
    implements SearchableEntityType<SsisControlFlow, String>,
        BrowsableEntityType<SsisControlFlow, String>,
        MutableType<SsisControlFlowUpdateInput, SsisControlFlow> {

  //  name: ssisControlFlow
  //  category: core
  //  keyAspect: ssisControlFlowKey
  //  aspects:
  //          - domains
  //      - deprecation
  //      - ssisControlFlowInfo
  ...
  private static final String ENTITY_NAME = "ssisControlFlow";

  private final EntityClient _entityClient;

  public SsisControlFlowType(final EntityClient entityClient) {
    _entityClient = entityClient;
  }

  @Override
  public Class<SsisControlFlow> objectClass() {
    return SsisControlFlow.class;
  }

  @Override
  public Class<SsisControlFlowUpdateInput> inputClass() {
    return SsisControlFlowUpdateInput.class;
  }

  @Override
  public EntityType type() {
    return EntityType.SSIS_CONTROL_FLOW;
  }
  ...
  @Override
  public List<DataFetcherResult<SsisControlFlow>> batchLoad(
    ...
    try {
      ...
      final Map<Urn, EntityResponse> ssisPackageMap =
          _entityClient.batchGetV2(
              Constants.SSIS_CONTROLFLOW_ENTITY_NAME,
              new HashSet<>(urns),
              ASPECTS_TO_RESOLVE,
  ...
  @Override
  public SsisControlFlow update(
      @Nonnull String urn, @Nonnull SsisControlFlowUpdateInput input, @Nonnull QueryContext context)
      throws Exception {
  ...
  private boolean isAuthorized(
      @Nonnull String urn,
      @Nonnull SsisControlFlowUpdateInput update,
  ...
  private DisjunctivePrivilegeGroup getAuthorizedPrivileges(
      final SsisControlFlowUpdateInput updateInput) {
    ...
    if (updateInput.getGlobalTags() != null) {
      specificPrivileges.add(
          com.linkedin.metadata.authorization.PoliciesConfig.EDIT_ENTITY_TAGS_PRIVILEGE.getType());
    }
